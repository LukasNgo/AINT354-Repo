...
{
    // references: https://answers.unity.com/questions/41931/how-to-randomly-change-the-intensity-of-a-point-li.html

    private Light light;

    public float MinLightIntensity = 50.0F;
    public float MaxLightIntensity = 50.0F;
